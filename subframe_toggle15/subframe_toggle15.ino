      ...
      switch (imaging_state)
      {
        case S_IM1:
          if (line_idx < SUBFRAME_LINE1 + IM_LINE_OFFSET)
            ...
            SET(PORTC,0);
          else if (line_idx < SUBFRAME_LINE5 + IM_LINE_OFFSET)
            CLR(PORTC,0);
          else if (line_idx < SUBFRAME_LINE6 - IM_LINE_OFFSET)
            SET(PORTC,0);
          else if (line_idx < SUBFRAME_LINE7 + IM_LINE_OFFSET)
            CLR(PORTC,0);
          else if (line_idx < SUBFRAME_LINE8 - IM_LINE_OFFSET)
            SET(PORTC,0);
